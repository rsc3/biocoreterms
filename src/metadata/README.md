 ...
 * [biocoreterms.yml](biocoreterms.yml)
     * Determines how your purl.obolibrary.org/obo/biocoreterms/ redirects will be handled
     ...
     * Paste in the contents of [biocoreterms.yml](biocoreterms.yml)
 ...
 * [biocoreterms.md](biocoreterms.md)
     ...
     * Paste in the contents of [biocoreterms.md](biocoreterms.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
